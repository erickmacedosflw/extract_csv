  ...
  return (
    <main>
      ...
      <section className="docs-page-content">
        ...
        <div className="doc-block"><p className="eyebrow">ENTRADA · URL PÚBLICA</p><pre className="code-block">{urlExample}</pre><p>Use qualquer link HTTP ou HTTPS que baixe diretamente o arquivo. O download remoto aceita arquivos de até 10 MB e não salva o conteúdo.</p></div>
        ...
        <div className="doc-block response-doc"><p className="eyebrow">RESPOSTA</p><span className="status">200 OK</span><strong>Content-Type: text/csv; charset=utf-8 · separador ;</strong><pre className="response-code">name;value{`\n`}Alice;20</pre></div>
        <div className="doc-block limits"><p className="eyebrow">REGRAS</p><ul><li>Formatos: CSV, XLS e XLSX.</li><li>Excel: somente a primeira aba.</li><li>Base64: 3 MB; URL: 10 MB.</li><li>Qualquer URL HTTP/HTTPS pública, sem endereços internos.</li><li>Sem banco, arquivos ou histórico.</li><li>Erros retornam JSON com <code>error</code>.</li></ul></div>
      </section>
